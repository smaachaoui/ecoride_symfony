...
class PreferencesType extends AbstractType
{
    ...
    {
        $builder
            ->add('accepte_fumeurs', CheckboxType::class, [
            ...
            ->add('preferences_personnalisees', TextareaType::class, [
                ...
                'attr' => [
                    'class' => 'form-control',
                    'rows' => 4,
                    'placeholder' => 'Ex: Musique pendant le trajet, Discussion appréciée, Silence préféré...',
                ],
            ])
