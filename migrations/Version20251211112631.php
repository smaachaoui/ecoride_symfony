 ...
 */
final class Version20251211112631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE covoiturage ADD date_arrivee DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE covoiturage DROP date_arrivee');
        $this->addSql('ALTER TABLE participation CHANGE statut statut ENUM(\'en_attente\', \'accepte\', \'refuse\') DEFAULT \'en_attente\'');
